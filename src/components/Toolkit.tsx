...
const Toolkit = () => {
  return (
    <div className="w-[280px] min-h-screen bg-primary rounded-t-[15px] p-5 text-white shadow-lg">
      <div className="mb-8">
        ...
        <select 
          className="w-full p-3 rounded-lg bg-white/20 text-white placeholder-white/70 border-none focus:ring-2 focus:ring-white/20 mb-6"
          defaultValue=""
        >
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        {[
          ...
          return (
            <div
              key={tool.name}
              className="bg-white rounded-xl p-5 flex flex-col items-center justify-center gap-2.5 cursor-pointer hover:scale-105 transition-transform duration-200 hover:bg-white/90 shadow-sm"
            >
              <IconComponent strokeWidth={1.5} className="text-gray-500 w-10 h-10" />
